    ...
    <section className="py-16 bg-luxury-gradient">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <span className="badge-luxury bg-gold-100 text-gold-600 border border-gold-200 mb-3">
            ✦ {t('wholesale_banner.badge')}
          </span>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white rounded-full p-1 shadow-luxury flex gap-1">
            ...
            >
              {t('wholesale_banner.wholesale_label')} ✦
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-serif text-2xl text-charcoal-800">Розница</h3>
            </div>
            <p className="text-charcoal-400 text-sm mb-6">Для частных покупателей</p>
          ...
          >
            <div className="absolute top-4 right-4 badge-luxury bg-gold-100 text-gold-600 text-xs font-semibold border border-gold-200">
              ✦ ВЫГОДНО
            </div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-serif text-2xl text-charcoal-800">Оптом</h3>
            </div>
            <p className="text-charcoal-400 text-sm mb-6">Для бизнеса и перепродажи</p>
            <ul className="space-y-3 mb-8">

      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={closeCart}
            className="fixed inset-0 bg-charcoal-900/40 backdrop-blur-sm z-[80]"
          />
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-[90] shadow-luxury-lg flex flex-col"
          >
            {/* Header */}
